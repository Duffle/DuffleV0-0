...
public class ModifyFoodActivity extends ListActivity {

private FoodDBAdapter datasource; 
		
	  public void onCreate(Bundle icicle) {
		    super.onCreate(icicle);
			datasource = new FoodDBAdapter(this.getBaseContext());
		    datasource.open();
		    final List<Food> w=datasource.getFoodList();
		    System.out.println("ModifyActivity ---> About to get all workouts");
		    //w=datasource.getAllWorkouts();
		    ArrayAdapter<Food> adapter2 = new ArrayAdapter<Food>(this,
	        ...
	        lv.setOnItemClickListener(new OnItemClickListener() {
	          public void onItemClick(AdapterView<?> parent, View view,
	        	  ...
	        	  long foodID= w.get(position).getID();
	...
	public boolean onCreateOptionsMenu(Menu menu) {
		getMenuInflater().inflate(R.menu.activity_modify_food, menu);
		return true;
	}
